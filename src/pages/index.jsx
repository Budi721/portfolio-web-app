...
import logoMicrovac from '@/images/logos/microvac.png'
import logoLacak from '@/images/logos/lacak.png'
import logoGolek from '@/images/logos/golek.svg'
    ...
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <ol className="mt-6 space-y-4">
        {resume.map((role, roleIndex) => (
          <li key={role.start} className="flex gap-4">
            <div
      ...
      <Button href="/resume.pdf" variant="secondary" className="group mt-6 w-full" download={true}>
        Download CV
        <ArrowDownIcon
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/BudiRahmawan6"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://instagram.com/rahmawanbd"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/Budi721"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://linkedin.com/in/rahmawanbd"
